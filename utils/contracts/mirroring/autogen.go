...
// LastTriggeredTimestamp is a free data retrieval call binding the contract method 0xfadfb6d2.
//
// Solidity: function lastTriggeredTimestamp() view returns(uint256)
func (_Mirroring *MirroringCaller) LastTriggeredTimestamp(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Mirroring.contract.Call(opts, &out, "lastTriggeredTimestamp")
...
//
// Solidity: function lastTriggeredTimestamp() view returns(uint256)
func (_Mirroring *MirroringSession) LastTriggeredTimestamp() (*big.Int, error) {
	return _Mirroring.Contract.LastTriggeredTimestamp(&_Mirroring.CallOpts)
}

// LastTriggeredTimestamp is a free data retrieval call binding the contract method 0xfadfb6d2.
//
// Solidity: function lastTriggeredTimestamp() view returns(uint256)
func (_Mirroring *MirroringCallerSession) LastTriggeredTimestamp() (*big.Int, error) {
	return _Mirroring.Contract.LastTriggeredTimestamp(&_Mirroring.CallOpts)
}
